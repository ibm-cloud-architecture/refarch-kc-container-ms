...
with open('container_matrix_door_open.csv', mode='w') as container_file:
    ...
    for i in  range_list:
    	...
    	container_writer.writerow([timestamp, id, np.exp(np.random.uniform(i+0.1, i+0.5)), 4.4, gauss(2.5,1.0), gauss(10.0,2.0), random.randint(1,5), 
